...
<body>
    ...
    <div>
        ...
        <div class="main md:ml-32 md:mr-32 ml-5 mr-5">
            ...
            $response = getJoinRecord('items WHERE item_is_auctioned = 0',$statement);
            if(!empty($response)){
                foreach($response as $data){
                    echo "
                    <div class='pb-5' onclick='buyItem(\"".$data['item_id']."\")' style='cursor: pointer;'>
                        <div>
    ...
    <script>
        ...
        function buyItem(item_id){
            encodeItemId = encodeURIComponent(item_id);
            window.location.href = "buy.php?item_id=" + encodeItemId;
        }
