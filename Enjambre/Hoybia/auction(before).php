    ...
    <div>
        ...
        <header class="header bg-gray-100 px-2 w-full">
            <nav class="nav flex justify-between items-center">
                <div>
                    <a href="home.html"><img class="w-95 h-16" src="./img/logo.png" alt="logo"></a>
                </div>
        ...
        <div class="py-2" >
           ...
           <nav class="flex justify-center">
            <ul class="flex md:gap-40 gap-10 font-bold">
                <li class="hover:text-orange-500"><a href="home.html">HOME</a></li>
                <li class="hover:text-orange-500"><a class="text-orange-500" href="#" href="selling.html">SELL</a></li>
        ...
        <div class="main md:ml-32 md:mr-32 ml-5 mr-5">
            ...
            <div class="border-t-2 border-gray-500">
                ...
                <div class="flex justify-center items-center my-5 " >
                    <label for="files" class="cursor-pointer">
                        <div class="flex justify-center items-center border-2 border-gray-500 rounded-md flex-col bg-gray-100" style="width: 150px; height: 150px;">
                            ...
                            <input type="file" name="upload" id="files" class="hidden" accept="image/png, image/jpeg, image/jpg" multiple="multiple">
                        </div>
                    </label>
                ...
                <div class="flex md:flex-row flex-col gap-2">
                    <input class="rounded-md pl-2 border-2 border-gray-400"type="text" name="titleTitle" id="itemTitle" placeholder="Title">
                    <input class="rounded-md pl-2 border-2 border-gray-400"type="text" name="price" id="price" placeholder="Price">
                    <input class="rounded-md pl-2 border-2 border-gray-400"type="text" name="quantity" id="quantity" placeholder="Quantity">
                    
                </div>
                <div class="">
                    <select class="mt-5 rounded-md pl-2 border-2 border-gray-400 mr-2"name="condition" id="condition">
                        <option hidden>Condition</option>
                        <option value="likenew">Used - Like New</option>
                        <option value="good">Used - Good</option>
                        <option value="fair">Used - Fair</option>
                    </select>
                    <select class="rounded-md pl-2 border-2 mt-5 border-gray-400"name="category" id="category">
                    ...
                    <select class="mt-5 rounded-md pl-2 border-2 border-gray-400" id="select" onchange="myFunction()">
                        <option value="sell">Sell</option>
                        <option value="auction">Auction</option>
                    </select>
                </div>

                <textarea id="Description" rows="4" class="block p-2.5 bg-gray-100 border-gray-300 " placeholder="Item Description" style="width: 50%; margin-top: 20px;"></textarea>
                <!-- <input class="mt-5 rounded-md pl-2 border-2 border-gray-400"type="textarea" name="Description" id="Description" placeholder="Description"> -->
                ...
                <div id="sell" class="border-t-2 border-gray-500 mt-5 pt-2" style="display:block">
                    ...
                    <div style="text-align: right;">
                        <button class="sellBtn w-24 h-10 border-2 border-orange-500 text-white bg-orange-500 rounded-3xl font-bold hover:bg-gray-50 hover:text-orange-500 shadow-lg drop-shadow-lg" id="sellBtn">Sell</button>
                    </div>
                </div>
                <div  id="auction" class="border-t-2 border-gray-500 mt-5 pt-2" style="display: none;">
                    ...
                    <br>
                    <div class="flex md:flex-row flex-col gap-2">
                        <input class="rounded-md pl-2 border-2 border-gray-400"type="date" placeholder="Date-start">
                        <input class="rounded-md pl-2 border-2 border-gray-400"type="date" placeholder="Date-end">
                        <input class="rounded-md pl-2 border-2 border-gray-400"type="time" placeholder="Time-start">
                        <input class="rounded-md pl-2 border-2 border-gray-400"type="time" placeholder="Time-end">
                    ...
                    <div style="text-align: right;">
                        <button class="auctionBtn w-24 h-10 border-2 border-orange-500 text-white bg-orange-500 rounded-3xl font-bold hover:bg-gray-50 hover:text-orange-500 mt-2 shadow-lg drop-shadow-lg" id="auctionBtn">Auction</button>
                    </div>
                </div>
           </div> 
        </div>
